...
const passwordSectionProps = computed(() => {
	if (activeSectionName.value === 'password-section') {
		return {username: username.value, firstName: firstName.value, lastName: lastName.value}
	}
})
