...
import { getAvatar, getFullName, getName, getOddContact, getLastSeen } from "../../../../utils";
    ...
    <div>
        <div class="mb-6 px-5 flex justify-between items-center">
            ...
            <Typography variant="heading-1" id="modal-title" class="outline-none" tabindex="0">
                <span v-if="(props.conversation as Conversation).type === 'simple' || props.contact">Contact</span>
            ...
            <div class="flex">
                ...
                <div class="w-full flex flex-col items-start">
                    ...
                    <Typography variant="body-2" class="font-extralight">
                        <!--last seen-->
                        <span v-if="(props.conversation as Conversation).type === 'simple' || contact">
                            {{ getLastSeen(props.conversation) }}
                        </span>
        ...
        <div class="w-full py-5 border-t border-gray-100 dark:border-gray-700">
            <!--(contact) username-->
            <div v-if="(conversation as Conversation).type === 'simple' || props.contact"
        ...
        <div class="w-full border-t border-gray-100 dark:border-gray-700">
            <!--block contact-->
            <div v-if="(props.conversation as Conversation).type === 'simple' || props.contact" class="px-5 pt-5 group">
