...
const buttonClasses = computed(() => {
    ...
    // color
    if ((props.variant === 'ghost' && props.color === 'primary') || (props.variant === 'ghost' && !props.color))
        classes = [...classes, 'hover:bg-green-50', 'hover:text-green-400', 'active:bg-green-100', 'dark:hover:bg-gray-600'];

    else if (props.variant === 'ghost' && props.color === 'danger')
...
const textClasses = computed(() => {
    ...
    if (props.variant === 'ghost' && !props.color)
